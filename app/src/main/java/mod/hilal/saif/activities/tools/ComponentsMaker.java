...
public class ComponentsMaker extends Activity {
    ...
    private static final String PATH_COMPONENTS_FILE = ".sketchwaregames/data/system/component.json";
    private static final String PATH_COMPONENT_EXPORT = ".sketchwaregames/data/system/export/components/";
