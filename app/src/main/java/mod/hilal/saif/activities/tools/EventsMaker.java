...
public class EventsMaker extends Activity {
    ...
    private void exportAll() {
        ...
        SketchwareUtil.toast("Successfully exported events to:\n" +
                "/Internal storage/.sketchwaregames/data/system/export/events", Toast.LENGTH_LONG);
    }

    private void export(int p) {
        String concat = FileUtil.getExternalStorageDir().concat("/.sketchwaregames/data/system/export/events/");
