...
public class ConfigActivity extends Activity {
    ...
    public static final File SETTINGS_FILE = new File(FileUtil.getExternalStorageDir(), ".sketchwaregames/data/settings.json");
    ...
    public static String getBackupPath() {
        ...
        return "/.sketchwaregames/backups/";
    }
    ...
    public static Object getDefaultValue(String key) {
        switch (key) {
            ...
            case SETTING_BLOCKMANAGER_DIRECTORY_PALETTE_FILE_PATH:
                return "/.sketchwaregames/resources/block/My Block/palette.json";

            case SETTING_BLOCKMANAGER_DIRECTORY_BLOCK_FILE_PATH:
                return "/.sketchwaregames/resources/block/My Block/block.json";
    ...
    private void initialize() {
        ...
        addTextInputPreference("Backup directory",
                "The default directory is /Internal storage/.sketchwaregames/backups/.", v -> {
