...
public class EventsHandler {
    ...
    public static final String CUSTOM_EVENTS_FILE_PATH = FileUtil.getExternalStorageDir() + "/.sketchwaregames/data/system/events.json";
    public static final String CUSTOM_LISTENERE_FILE_PATH = FileUtil.getExternalStorageDir() + "/.sketchwaregames/data/system/listeners.json";
    ...
    private static ProjectFileBean currentActivity;
    /**
        ...
        switch (name) {
            ...
            case "Resize":
                return "@Override\r\n" +
                        ...
                        param + "\r\n" +
                        "}";
                //Not used for game DNA MOBILE EDIT
            case "Import":
                // Changed from: "...vF\n${param}\n//3b..."
