...
public class ExtraBlockFile {
    ...
    public static String getExtraBlockFile() {
        ...
        if (EXTRA_BLOCKS_DATA_FILE.exists() && !(fileContent = FileUtil.readFile(EXTRA_BLOCKS_DATA_FILE.getAbsolutePath()))
                .equals("")) {
            return fileContent;
        } else {
            return "[]";
    ...
    public static String getMenuDataFile() {
        ...
        if (EXTRA_MENU_DATA_FILE.exists() && !(fileContent = FileUtil.readFile(EXTRA_MENU_DATA_FILE.getAbsolutePath()))
                .equals("")) {
            return fileContent;
        } else {
    ...
    public static String getMenuBlockFile() {
        ...
        if (EXTRA_MENU_BLOCK_FILE.exists() && !(fileContent = FileUtil.readFile(EXTRA_MENU_BLOCK_FILE.getAbsolutePath()))
                .equals("")) {
            return fileContent;
        } else {
