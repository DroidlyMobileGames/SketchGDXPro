package mod.dev.aldi.sayuti.block;
...
public class ExtraPaletteBlock {
    ...
    private void blockComponents() {
        ...
        for (int i = 0, componentsSize = components.size(); i < componentsSize; i++) {
            ...
            if (component.type != 27) {
                logicEditor.a(component.componentId, "p",
                        ComponentBean.getComponentTypeName(component.type), "getVar").setTag(component.componentId);
            }
        }
    }
        ...
        if (eventName.equals("onBindCustomView")) {
            ...
            if (viewBean != null) {
                ...
                if (viewBeanCustomView != null && viewBeanCustomView.length() > 0) {
                    ArrayList<ViewBean> customViews = jC.a(sc_id).d(
                            ProjectFileBean.getXmlName(viewBeanCustomView));
    ...
    public void setBlock(int paletteId, int paletteColor) {
        ...
        switch (paletteId) {
            ...
            case 7:
                //DNA MOBILE this class is the left palette that is loaded when the right palette gets selected
                      logicEditor.b("Add component", "componentAdd");//Adds the Add component button when the user selects components
                ...
                if (extraBlocks.isComponentUsed(
                        ComponentBean.COMPONENT_TYPE_INTENT)
                ...
                if (extraBlocks.isComponentUsed(ComponentBean.COMPONENT_TYPE_REWARDED_VIDEO_AD)) {
                    ...
                    logicEditor.a(" ", "rewardedAdRegisterFullScreenContentCallback");
                }
