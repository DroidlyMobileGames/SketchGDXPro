...
public class ExportProjectActivity extends BaseAppCompatActivity {
        ...
        btnExportAppBundle.setOnClickListener(v -> {
            aB dialog = new aB(this);
                ...
                GetKeyStoreCredentialsDialog credentialsDialog = new GetKeyStoreCredentialsDialog(this,
                        ...
                        "Copy your keystore to /Internal storage/sketchwaregames/keystore/release_key.jks " +
        ...
        btn_sign_apk.setOnClickListener(v -> {
            GetKeyStoreCredentialsDialog credentialsDialog = new GetKeyStoreCredentialsDialog(this,
                    ...
                    "To sign an APK, you need a keystore. Use your already created one, and copy it to " +
                            "/Internal storage/sketchwaregames/keystore/release_key.jks and enter the alias's password.\n" +
    ...
    private void initializeOutputDirectories() {
        signed_apk_postfix = File.separator + "sketchwaregames" + File.separator + "signed_apk";
        export_src_postfix = File.separator + "sketchwaregames" + File.separator + "export_src";
    ...
    private static class BuildingAsyncTask extends MA implements DialogInterface.OnCancelListener, BuildProgressReceiver, mod.buildcompiler.BuildProgressReceiver {
        ...
        public void b() {
            ...
            try {
                ...
                builder = new Dp(this, a, project_metadata);
                ...
                stringfogHandler.start((mod.buildcompiler.BuildProgressReceiver) this, builder);
                if (canceled) {
                    cancel(true);
                    return;
                }
                ...
                if (buildingAppBundle) {
                    ...
                    String signedAppBundleDirectoryPath = FileUtil.getExternalStorageDir()
                            + File.separator + "sketchwaregames"
        ...
        public void a() {
            ...
            if (buildingAppBundle && new File(Environment.getExternalStorageDirectory(),
                    "sketchwaregames" + File.separator + "signed_aab" + File.separator + aabFilename).exists()) {
                ...
                dialog.a("You can find the generated, signed AAB file at:\n" +
                        "/Internal storage/sketchwaregames/signed_aab/" + aabFilename);
