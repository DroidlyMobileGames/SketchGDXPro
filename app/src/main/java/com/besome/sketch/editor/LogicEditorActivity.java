...
public class LogicEditorActivity
        extends BaseAppCompatActivity
        implements View.OnClickListener, Vs, View.OnTouchListener, MoreblockImporterDialog.CallBack {
    ...
    public final void K() {//Dialog when variable remove requested
        aB aBVar = new aB(this);
    ...
    public final void b(String str, String str2) {
        TextView a2 = m.a(str);
        a2.setGravity(Gravity.LEFT|Gravity.CENTER_VERTICAL);
        a2.setTag(str2);
    ...
    public void e(Ss ss) {
        ...
        ((TextView) a2.findViewById(R.id.tv_desc_intent_usage)).setText(xB.b().a(getContext(),
                R.string.property_description_component_intent_usage));
        EditText editText = a2.findViewById(R.id.ed_input);
        ((TextInputLayout) a2.findViewById(R.id.ti_input)).setHint(xB.b().a(this, R.string.property_hint_enter_value));
        editText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
        editText.setText(ss.getArgValue().toString());
    ...
    public void onPostCreate(Bundle bundle) {
        ...
        if (D.equals("moreBlock")) {
            title = xB.b().a(getContext(), R.string.root_spec_common_define) + " "
                    + ReturnMoreblockManager.getLogicEditorTitle(jC.a(B).b(M.getJavaName(), C));
        } else if (C.equals("_fab")) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (actionMasked == MotionEvent.ACTION_MOVE) {
            ...
            p.setDummyVisibility(View.GONE);//Hides the transparent image DNA MOBILE EDIT
            if (!p.getAllow()) {
                Rs rs2 = (Rs) v;
