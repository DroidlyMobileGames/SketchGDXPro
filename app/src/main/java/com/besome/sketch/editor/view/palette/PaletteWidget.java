...
import a.a.a.wB;
import mod.dev.aldi.sayuti.editor.view.palette.IconBadgeView;
import mod.dev.aldi.sayuti.editor.view.palette.IconBottomNavigationView;
import mod.dev.aldi.sayuti.editor.view.palette.IconCardView;
import mod.dev.aldi.sayuti.editor.view.palette.IconCircleImageView;
import mod.dev.aldi.sayuti.editor.view.palette.IconCodeView;
import mod.dev.aldi.sayuti.editor.view.palette.IconCollapsingToolbar;
import mod.dev.aldi.sayuti.editor.view.palette.IconGoogleSignInButton;
import mod.dev.aldi.sayuti.editor.view.palette.IconLottieAnimation;
import mod.dev.aldi.sayuti.editor.view.palette.IconMaterialButton;
import mod.dev.aldi.sayuti.editor.view.palette.IconOTPView;
import mod.dev.aldi.sayuti.editor.view.palette.IconPatternLockView;
import mod.dev.aldi.sayuti.editor.view.palette.IconRadioGroup;
import mod.dev.aldi.sayuti.editor.view.palette.IconRecyclerView;
import mod.dev.aldi.sayuti.editor.view.palette.IconSwipeRefreshLayout;
import mod.dev.aldi.sayuti.editor.view.palette.IconTabLayout;
import mod.dev.aldi.sayuti.editor.view.palette.IconTextInputLayout;
import mod.dev.aldi.sayuti.editor.view.palette.IconViewPager;
import mod.dev.aldi.sayuti.editor.view.palette.IconWaveSideBar;
import mod.dev.aldi.sayuti.editor.view.palette.IconYoutubePlayer;
...
public class PaletteWidget extends LinearLayout {
    ...
    public View a(a layoutType, String tag) {
        LinearLayout layout;
        switch (layoutType) {
            case a:
    ...
    public View a(b widgetType, String tag, String text, String resourceName) {
        IconBase iconBase;
        switch (widgetType) {
            case a:
