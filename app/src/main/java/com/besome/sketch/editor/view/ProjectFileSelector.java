...
public class ProjectFileSelector extends LinearLayout implements View.OnClickListener {
    ...
    public void setXmlFileName(final ProjectFileBean projectFileBean) {
        if (projectFileBean == null) {
            ...
            if (fileType == 0) {
                currentJavaFileName = projectFileBean.getJavaName().replace("Fragment","");
    ...
    private void initializeDropdown(Context context) {
        ...
        dropdown.setLayoutParams(new LayoutParams(s, s));
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder
                    (LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.file_selector_popup_select_java_list_item, parent, false));
        }
