...
public class ViewProperty extends LinearLayout implements Kw {
    ...
    private class GroupItem extends LinearLayout implements OnClickListener {
    ...
    private class SeeAllPropertiesFloatingItem extends LinearLayout implements OnClickListener {
