...
public class MainActivity extends BasePermissionAppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private static ProjectsFragment projectsFragment = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tryLoadingCustomizedAppStrings(this);
        ...
        if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
            ...
            dialog.b("Welcome to SketchGDX");
            dialog.a("SketchGDX was designed for the purpose of developing games with libGDX." +
                    "  All files required to use libGDX have been modified to be automatically added" +
                    " when you create your projects.  All custom blocks (for now) are found on the " +
                    "YouTube guides for this application to work.  I Mister DN EH have worked hours" +
                    " to remod the modded Sketchware Pro so I hope you enjoy what this has become and" +
                    " make some awesome games!  If you want more information you can jump over to my channel" +
                    " and see what I all did to the modded Sketchware Pro to make this remod! \n\n" +
                    "  Take care and enjoy!");
    ...
    public void onPageSelected(int position) {
        if (position == 0){
            if (j() && projectsFragment != null
                    && projectsFragment.getProjectsCount() == 0) {
                projectsFragment.refreshProjectsList();
            }
        }
    }
    ...
    public void tryLoadingCustomizedAppStrings(Context context) {
