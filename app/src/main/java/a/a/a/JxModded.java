...
public class JxModded {
    ...
    public JxModded(jq jqVar, ProjectFileBean projectFileBean, eC eCVar) {
    ...
    public String generateCode() {
        ...
        sb.append(EOL);
        if (isFragment) {
            //sb.append("public ".concat(projectFileBean.getActivityName().replace("Fragment","").concat("() {"))).append(EOL);
        }
        if (isDialogFragment){
        ...
        //Very important how this is setup DO NOT change or remove as this handles the Game Screen implementations
    ...
    private void handleClass() {//This is going to be the Screen classes perhaps
        addImport("android.os.Bundle");
        addImport("com.badlogic.gdx.*");
        addImport("com.badlogic.gdx.math.*");
        addImport("com.badlogic.gdx.audio.*");
