...
public class wq {
    ...
    public static final String A = "sketchwaregames" + File.separator + "localization" + File.separator + "strings_provided.xml";
    public static final String B = "sketchwaregames" + File.separator + "signed_apk";
    public static final String C = "sketchwaregames" + File.separator + "keystore";
    public static final String D = "sketchwaregames" + File.separator + "keystore" + File.separator + "release_key.jks";
    public static final String E = "sketchwaregames" + File.separator + "service_account";
    public static final String F = ".sketchwaregames" + File.separator + "upload";
    ...
    public static final String a = ".sketchwaregames" + File.separator + "libs";
    public static final String b = ".sketchwaregames" + File.separator + "mysc";
    public static final String c = ".sketchwaregames" + File.separator + "mysc" + File.separator + "list";
    public static final String d = ".sketchwaregames" + File.separator + "data";
    public static final String e = ".sketchwaregames" + File.separator + "bak";
    public static final String f = ".sketchwaregames" + File.separator + "temp" + File.separator + "images";
    public static final String g = ".sketchwaregames" + File.separator + "temp" + File.separator + "sounds";
    public static final String h = ".sketchwaregames" + File.separator + "temp" + File.separator + "fonts";
    public static final String i = ".sketchwaregames" + File.separator + "temp" + File.separator + "proj";
    public static final String j = ".sketchwaregames" + File.separator + "temp" + File.separator + "data";
    public static final String l = ".sketchwaregames" + File.separator + "resources";
    public static final String m = ".sketchwaregames" + File.separator + "resources" + File.separator + "icons";
    public static final String n = ".sketchwaregames" + File.separator + "resources" + File.separator + "images";
    public static final String o = ".sketchwaregames" + File.separator + "resources" + File.separator + "sounds";
    public static final String p = ".sketchwaregames" + File.separator + "resources" + File.separator + "fonts";
    public static final String r = ".sketchwaregames" + File.separator + "download" + File.separator + "apk";
    public static final String s = ".sketchwaregames" + File.separator + "download" + File.separator + "data";
    public static final String t = ".sketchwaregames" + File.separator + "tutorial" + File.separator + "images";
    public static final String u = ".sketchwaregames" + File.separator + "tutorial" + File.separator + "sounds";
    public static final String v = ".sketchwaregames" + File.separator + "tutorial" + File.separator + "fonts";
    public static final String w = ".sketchwaregames" + File.separator + "tutorial" + File.separator + "proj";
    public static final String x = ".sketchwaregames" + File.separator + "collection";
    public static final String y = "sketchwaregames" + File.separator + "localization";
    public static final String z = "sketchwaregames" + File.separator + "localization" + File.separator + "strings.xml";
    ...
    public static String c() {
        return getAbsolutePathOf(".sketchwaregames" + File.separator + "download");
    }
    ...
    public static String q() {
        return getAbsolutePathOf(".sketchwaregames" + File.separator);
    }
    ...
    public static String s() {
        return getAbsolutePathOf("sketchwaregames");
    }
