...
public class rs extends qA implements View.OnClickListener, MoreblockImporterDialog.CallBack {
    ...
    public ArrayList<EventBean> activityEvents;
    ...
    public static int a(int i) {
        ...
        return i == 1 ? R.drawable.component_96 : 0;
    }
        ...
        if (currentActivity != null) {
            ...
            if (screencheck.contains("_fragment") &&
               ...
               //Add default activity methods here
                ...
                activityEvents.add(eventBean5);

                EventBean eventBean6 = new EventBean(
                        EventBean.EVENT_TYPE_ACTIVITY, -1,
                        "Resume", "resume");
                eventBean6.initValue();
                activityEvents.add(eventBean6);

                EventBean eventBean7 = new EventBean(
                        EventBean.EVENT_TYPE_ACTIVITY, -1,
                        "Hide", "hide");
                eventBean7.initValue();
                activityEvents.add(eventBean7);
    ...
    private void showSaveMoreBlockToCollectionsDialog(int moreBlockPosition) {
        ...
        ((TextView) a2.findViewById(R.id.tv_favorites_guide)).setText(xB.b().a(getContext(),
                R.string.logic_more_block_favorites_save_guide));
    ...
    private void showEditMoreBlockNameDialog(MoreBlockCollectionBean moreBlock) {
        ...
        ((TextView) customView.findViewById(R.id.tv_favorites_guide)).setText(xB.b().a(getContext(),
                R.string.logic_more_block_desc_change_block_name));
    ...
    //DNA MOBILE I will come back to this class later to see if I can find out where to place event selects
    ...
    private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.common_category_triangle_item, parent, false));
        }
    ...
    //This is the main holder for all the events within a class
    private class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if (eventBean.eventType == EventBean.EVENT_TYPE_ACTIVITY) {
                if (eventBean.eventName.equals("show")
                        ...
                        || eventBean.eventName.equals("resize")
                        || eventBean.eventName.equals("pause")
                        || eventBean.eventName.equals("resume")
                        || eventBean.eventName.equals("hide")
                        || eventBean.eventName.equals("dispose")) {
                    // Hide Delete
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.fr_logic_list_item, parent, false));
        }
