...
public class yq {
    ...
    public void h() {
        ...
        fileUtil.b(projectMyscPath + File.separator + "build.gradle",
                Lx.c("3.4.2", "4.3.3"));
    }
    ...
    public void a(Context context) {
        ...
        String javaDir = FileUtil.getExternalStorageDir() + "/.sketchwaregames/data/" + sc_id + "/files/java/";
    ...
    public ArrayList<SrcCodeBean> a(hC projectFileManager, eC projectDataManager, iC projectLibraryManager, boolean exportingProject) {
        ...
        final String javaDir =
                FileUtil.getExternalStorageDir() + "/.sketchwaregames/data/" + sc_id + "/files/java/";
        final String layoutDir =
                FileUtil.getExternalStorageDir() + "/.sketchwaregames/data/" + sc_id + "/files/resource/layout/";
        List<File> javaFiles;
        {
